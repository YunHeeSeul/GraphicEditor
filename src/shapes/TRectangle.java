...
public class TRectangle extends TShape {//shape의 서브클래스

    public TRectangle() { //new는 그냥 메모리 확보용, new 할 때 파라미터 없이 하는 대신 enumeration 객체에서 우리가 직접 new 하지 않고
    ...
    public TShape clone() {
        return new TRectangle(); //TRec을 만들어줌
    }
